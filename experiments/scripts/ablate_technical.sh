...
lighter fit --config=./experiments/ablations/base.yaml,./experiments/ablations/frameworks/vicreg_intrasample.yaml,./experiments/ablations/backbones/segresenc.yaml; pkill -9 -f lighter
