...
class VICReg(nn.Module):
    ...
    def __init__(self, backbone: nn.Module, num_ftrs: int = 32, out_dim: int = 8192, spatial_dims: int = 3):
        """
        ...
        self.projection_head = BarlowTwinsProjectionHead(input_dim=num_ftrs, hidden_dim=8192, output_dim=out_dim)
        if spatial_dims == 2:
