...
# 20-shot 
lighter fit --config=./evaluation/totalseg.yaml,./evaluation/baselines/segresnetds.yaml --trainer#callbacks#0#until_epoch=0 --vars#percentage=2 --vars#name="baseline" --vars#project="totalseg" --vars#wandb_group='few-shot_20' 
...
# lighter fit --config=./evaluation/totalseg.yaml,./evaluation/baselines/segresnet_vista3d.yaml --trainer#callbacks#0#until_epoch=0 --vars#percentage=2 --vars#name="vista3d_segresnet" --vars#project="totalseg" --vars#wandb_group='few-shot_20'
...
# lighter fit --config=./evaluation/totalseg.yaml,./evaluation/baselines/segresnet_vista3d.yaml --trainer#callbacks#0#until_epoch=0 --vars#percentage=1 --vars#name="vista3d_segresnet" --vars#project="totalseg" --vars#wandb_group='few-shot_10'
...
# lighter fit --config=./evaluation/totalseg.yaml,./evaluation/baselines/segresnet_vista3d.yaml --trainer#callbacks#0#until_epoch=0 --vars#percentage=0.5 --vars#name="vista3d_segresnet" --vars#project="totalseg" --vars#wandb_group='few-shot_5'
