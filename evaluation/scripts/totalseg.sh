...
lighter fit --config=./evaluation/totalseg.yaml,./evaluation/frameworks/ct_fm.yaml
...
lighter fit --config=./evaluation/totalseg.yaml,./evaluation/frameworks/ct_fm.yaml --trainer#callbacks=None --vars#percentage=2
...
lighter fit --config=./evaluation/totalseg.yaml,./evaluation/frameworks/ct_fm.yaml --trainer#callbacks=None --vars#percentage=1
...
lighter fit --config=./evaluation/totalseg.yaml,./evaluation/frameworks/ct_fm.yaml --trainer#callbacks=None --vars#percentage=0.5
...
######################### Full ############################
lighter fit --config=./evaluation/totalseg.yaml,./evaluation/baselines/random_init.yaml --trainer#callbacks=None
lighter fit --config=./evaluation/totalseg.yaml,./evaluation/baselines/suprem_unet.yaml --trainer#callbacks=None
lighter fit --config=./evaluation/totalseg.yaml,./evaluation/baselines/suprem_segresnet.yaml --trainer#callbacks=None
lighter fit --config=./evaluation/totalseg.yaml,./evaluation/frameworks/ct_fm.yaml --trainer#callbacks=None
