...
parser.add_argument('--extension', type=str, required=True, help='File extension to look for (e.g., "*.nrrd")')
parser.add_argument('--output_file', type=str, required=True, help='Output pickle file path to save features')
